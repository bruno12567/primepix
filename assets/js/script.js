...
function initVideo(videoId, username){
    ...
    uptadeProgressTimer(videoId, username)
    
}

function uptadeProgressTimer(videoId, username){
    ...
    $("video").on("playing", function(event){
        ...
        timer = window.setInterval(function(){
            uptadeProgress(videoId, username, event.target.currentTime);   
        }, 3000);
    })
    .on("ended", function() {
...
function uptadeProgress(videoId, username, progress){
